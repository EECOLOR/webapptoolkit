...
public class RestController extends RenderingController {
	...
	private String _makeRestCall(RequestMethod requestMethod, String key, String value,
			HttpServletRequest httpServletRequest, String context) throws MalformedURLException,
